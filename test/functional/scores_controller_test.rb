...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { language_id: @score.language_id, number: @score.number, user_id: @score.user_id }
    end
  ...
  test "should update score" do
    put :update, id: @score, score: { language_id: @score.language_id, number: @score.number, user_id: @score.user_id }
    assert_redirected_to score_path(assigns(:score))
  end
